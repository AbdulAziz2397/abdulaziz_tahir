    ...
    <section id='aboutSection'>
      <div className="about-container">
        ...
        <div className="about-text">
          ...
          <p>
            I am <strong>Abdulaziz Tahir</strong>, a passionate <strong>Full Stack Developer</strong> dedicated to creating modern, scalable, and user-friendly digital solutions. With expertise in <strong>HTML</strong>, <strong>CSS</strong>, <strong>JavaScript</strong>, <strong>React</strong>, <strong>TypeScript</strong>, <strong>Node.js</strong>, <strong>Express.js</strong>, <strong>MongoDB</strong>, <strong>Firebase</strong>, <strong>Bootstrap</strong>, and <strong>Tailwind CSS</strong>, I craft seamless experiences across web and app development. My focus is on delivering high-quality, performance-driven projects that combine technical precision with creative problem-solving.
            <br />
            <br />
